        ...
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ...
                <div className='flex items-center justify-center rounded-full w-[28px] h-[28px] sm:w-[32px] sm:h-[32px] overflow-hidden relative flex-shrink-0'>
                    {userDetails ? (
                        <Image fill className='rounded-full object-cover ' src={userDetails.avatarUrl} alt="" />
                    ) : (
                        <UserAvatar avatarUrl="/default-avatar.svg" size={32} className="rounded-full object-cover" />
                    )}
                </div>
