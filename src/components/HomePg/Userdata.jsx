        ...
        <div>
            <div className="flex items-center justify-center w-full space-x-32 ">
                ...
                <div className="flex flex-col space-y-3 items-start ">
                    ...
                    <button className="border px-4 py-2 rounded-[8px] hover:bg-black hover:text-white transition-all focus:bg-transparent focus:text-black duration-300 ">Edit Profile</button>
                </div>
            </div>
        </div>
    )
