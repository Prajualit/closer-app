...
const ChatList: React.FC<ChatListProps> = ({ onSelectChat, selectedChatId, refreshTrigger, autoSelectChatId, chatRooms, setChatRooms }) => {
    ...
    const userDetails = useSelector((state: { user: { user: User } }) => state.user.user);
        ...
        if (socket) {
            const handleChatUpdate = (messageData: any) => {
                ...
                actualSetChatRooms((prev: ChatRoom[]) => {
                    ...
                    return updatedRooms.sort((a, b) => new Date(b.lastActivity || 0).getTime() - new Date(a.lastActivity || 0).getTime());
                });
            };
    ...
    }, [actualChatRooms, autoSelectChatId, selectedChatId, hasAutoSelected, onSelectChat]);
    ...
    const getOtherParticipant = (participants: Participant[]): Participant | undefined => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Button
                                        size="sm"
                                        variant="ghost"
                                        onClick={(e) => otherParticipant?._id && handleViewProfile(e, otherParticipant._id)}
